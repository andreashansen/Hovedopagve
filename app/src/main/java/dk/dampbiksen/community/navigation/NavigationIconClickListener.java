...
/**
 * {@link android.view.View.OnClickListener} used to translate the presenter sheet downward on
...
public class NavigationIconClickListener implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        final int translateY = height -
                context.getResources().getDimensionPixelSize(R.dimen.content_reveal_height);
